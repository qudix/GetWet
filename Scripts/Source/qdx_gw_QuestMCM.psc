...
qdx_gw_QuestLoop Property Loop Auto
...
Int B_ModActive
Int S_UpdateLoopFreq
Int S_UpdateLoopRange
Int B_ApplyPlayer
Int B_ApplyNPC
Int B_ApplyMale
Int B_ApplyFemale
...
Function ShowPageGeneral()
	...
	AddEmptyOption()
    AddHeaderOption("$GW_Header_ModPerformance")
    S_UpdateLoopFreq = AddSliderOption("$GW_Slider_UpdateLoopFreq", Config.UpdateLoopFreq, "{2} sec")
    S_UpdateLoopRange = AddSliderOption("$GW_Slider_UpdateLoopRange", Config.UpdateLoopRange, "{0}")
...
Event OnOptionSliderOpen(Int Item)
    ...
    If (Item == S_UpdateLoopFreq)
        Val = Config.UpdateLoopFreq
        Min = 10.0
        Max = 300.0
        Interval = 1
    ElseIf (Item == S_UpdateLoopRange)
        Val = Config.UpdateLoopRange
        Min = 100
        Max = 100000
        Interval = 100
...
Event OnOptionSliderAccept(Int Item, Float Val)
    ...
    If (Item == S_UpdateLoopFreq)
        Fmt = "{1} sec"
        Config.UpdateLoopFreq = Val
        Setting = "UpdateLoopFreq"
    ElseIf (Item == S_UpdateLoopRange)
        Fmt = "{0}"
        Config.UpdateLoopRange = Val
        Setting = "UpdateLoopRange"
    ElseIf (Item == S_VisualGlossinessMin)
        Fmt = "{1}"
...
Event OnOptionHighlight(Int Item)
	...
	ElseIf (Item == S_UpdateLoopFreq)
        Text = "$GW_Tip_UpdateLoopFreq"
    ElseIf (Item == S_UpdateLoopRange)
		Text = "$GW_Tip_UpdateLoopRange"
